...
<html>
    ...
    <body>
        ...
        <ul><!--Pour les listes-->
          ...
          <p>Sécurisez le partrimoine numérique de votre entreprise en stockant vos données sur nos infrastrucutes</br>sécurisées et offrez-vous un accès sécurisé en tout lieu.</p>
